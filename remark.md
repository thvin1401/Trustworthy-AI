...
- **Vị trí của Giới tính:** Biến `Personal_Status_Sex` nằm ngoài Top 10 về tầm quan trọng tổng thể, nhưng lại đóng vai trò quan trọng trong việc tạo ra bias.
...
#### a. Direct Bias (Ảnh hưởng trực tiếp)
Biến `Personal_Status_Sex` (đặc biệt là nhóm Nữ đã kết hôn/ly hôn và Nam độc thân) có SHAP values tổng ~0.18 và đóng góp trực tiếp vào kết quả dự báo lệch.

![Top Proxy Features Drivers](./Trustworthy_AI/output_readable/13_bias_potential.png)

#### b. Proxy Features (Biến đại diện)
